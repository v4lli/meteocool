...
def dbz2color(dbz):
    ...
    if dbz >= 170:
        return (0, 0, 0, 0)
    if dbz >= 70:
        return scale(0xFE, 0xFC, 0xFD, 10, dbz % (70), False, True)
    if dbz >= 55:
        return scale(0xFE, 0xFC, 0xFD, 15, dbz % (55))
    if dbz >= 45:
        return scale(0x98, 0x58, 0xC4, 10, dbz % (45))
    if dbz >= 40:
    ...
    if dbz >= 35:
        return scale(117, 0, 0, 5, dbz % (35), False, True)
    # if dbz >= 45:
    ...
    if dbz >= 30:
        # gelb
        return scale(87, 74, 0, 5, dbz % (30))
    if dbz >= 25:
        # gruen
        return scale(0x12, 0x8C, 0x15, 5, dbz % (25), True)
    # also redundant
    # if dbz >= 25:
    ...
    if dbz >= 10:
        return scale(0x0E, 0x22, 0xEE, 5, dbz % 10, True)
    if dbz >= 0:
