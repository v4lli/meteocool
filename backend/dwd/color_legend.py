...
for color in range(0, 65 * 2):
    draw.line((count, 0, count, image.size[1]-200), fill=dbz2color(color / 2.0), width=8)
    # small legend line
    if color % 2 == 0:
        draw.line((count-3, 290, count-3, image.size[1]-200), fill=(200, 200, 200, 255), width=1)
    if color % 10 == 0:
        draw.line((count-3, 280, count-3, image.size[1]-180), fill=(200, 200, 200, 255), width=2)
    count = count + 8
...
for color in range(0, 70 * 2):
    if color % 10 == 0 and color != 0:
        ...
        image.paste(ImageOps.colorize(w, (0,0,0), (100,100,100)), (count-137, 232),  w)
    count = count + 8
